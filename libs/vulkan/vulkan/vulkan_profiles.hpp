        ...
        bool ret = true;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    ret = ret && (s->properties.limits.maxDescriptorSetUniformBuffers >= 90);
                    ret = ret && (s->properties.limits.maxDescriptorSetUniformBuffersDynamic >= 8);
                    ret = ret && (s->properties.limits.maxDrawIndexedIndexValue >= 4294967294);
                    ...
                    ret = ret && (s->properties.limits.standardSampleLocations == VK_TRUE);
                    ret = ret && (vpCheckFlags(s->properties.limits.storageImageSampleCounts, (VK_SAMPLE_COUNT_1_BIT)));
                    ret = ret && (s->properties.limits.strictLines == VK_FALSE);
                    ret = ret && (s->properties.limits.subPixelInterpolationOffsetBits >= 4);
                    ret = ret && (s->properties.limits.subPixelPrecisionBits >= 4);
                    ret = ret && (s->properties.limits.subTexelPrecisionBits >= 4);
                    ...
                    ret = ret && (vpCheckFlags(s->properties.sparseProperties.residencyAlignedMipSize, VK_FALSE));
...
static const VpProfileDesc vpProfiles[] = {
    ...
    VpProfileDesc{
        ...
        &VP_ANDROID_BASELINE_2022::instanceExtensions[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::instanceExtensions) / sizeof(VP_ANDROID_BASELINE_2022::instanceExtensions[0])),
        &VP_ANDROID_BASELINE_2022::deviceExtensions[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::deviceExtensions) / sizeof(VP_ANDROID_BASELINE_2022::deviceExtensions[0])),
        nullptr, 0,
        &VP_ANDROID_BASELINE_2022::featureStructTypes[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::featureStructTypes) / sizeof(VP_ANDROID_BASELINE_2022::featureStructTypes[0])),
        VP_ANDROID_BASELINE_2022::featureDesc,
        &VP_ANDROID_BASELINE_2022::propertyStructTypes[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::propertyStructTypes) / sizeof(VP_ANDROID_BASELINE_2022::propertyStructTypes[0])),
        VP_ANDROID_BASELINE_2022::propertyDesc,
        nullptr, 0,
        nullptr, 0,
        &VP_ANDROID_BASELINE_2022::formatStructTypes[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::formatStructTypes) / sizeof(VP_ANDROID_BASELINE_2022::formatStructTypes[0])),
        &VP_ANDROID_BASELINE_2022::formatDesc[0], static_cast<uint32_t>(sizeof(VP_ANDROID_BASELINE_2022::formatDesc) / sizeof(VP_ANDROID_BASELINE_2022::formatDesc[0])),
        VP_ANDROID_BASELINE_2022::chainerDesc,
    },
#endif
#ifdef VP_KHR_roadmap_2022
    VpProfileDesc{
